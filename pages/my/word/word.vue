				...
				<tui-list-cell :lineLeft="false" @click="detail" v-for="(item,index) in list" :key="index">
					<view class="tui-item-box">
						<view class="tui-msg-box">
							<image v-if="item.rightnum >= 12" src="/static/images/my/word_success.png" class="tui-msg-pic" mode="widthFix"></image>
							<image v-else src="/static/images/my/word_error.png" class="tui-msg-pic" mode="widthFix"></image>
...
<script>
	...
	export default {
		...
		methods: {
			getAll(){
				this.tui.request('/user/wordresultinfo','GET',{page:this.pageIndex}).then((res) => {
